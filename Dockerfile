...
RUN yum install gcc glibc-devel zlib-devel \
	&& gu install native-image
COPY native-image-compiler.sh /usr/gvm-native
WORKDIR /workspace/target
CMD ["/bin/bash","/usr/gvm-native/native-image-compiler.sh","run"]